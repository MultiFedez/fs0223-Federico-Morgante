...
var AntonioMuratoreAutonomo = new MuratoreAutonomo(90000);
AntonioMuratoreAutonomo.getRedditoAnnuoNetto();
console.log("Hai pagato all'INPS: " + AntonioMuratoreAutonomo.getTasselnps() + "$");
console.log("Hai pagato per l'IRPEF: " + AntonioMuratoreAutonomo.getTasselrpef() + "$");
